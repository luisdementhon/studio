    ...
    <div className="relative flex flex-col bg-background">
      ...
      <main className="flex min-h-[85vh] flex-col items-center justify-center text-center p-4 pt-12">
        <div className="z-10 flex flex-col items-center gap-6">
          <Link href="/" aria-label="Accueil" className="mb-4">
              <DotlyLogo className="h-auto w-48 text-foreground" />
          </Link>
          
          <div className="font-headline">
            <h1 className="pb-4 text-4xl md:text-6xl font-bold tracking-tight text-foreground leading-snug [text-shadow:0_2px_4px_rgba(0,0,0,0.1),0_-1px_0px_rgba(255,255,255,0.2)]">
              Petite monnaie,<br />
              grands gestes.
            </h1>
          </div>
